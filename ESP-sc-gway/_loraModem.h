...
void txLoraModem(uint8_t *payLoad, uint8_t payLength, uint32_t tmst, uint8_t sfTx,uint8_t powe, uint32_t freq, uint8_t crc, uint8_t iiq, uint16_t bw);
void rxLoraModem();
void cadScanner();
void initLoraModem();
void startReceiver();
